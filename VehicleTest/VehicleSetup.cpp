...
#include "FrictionMapVehicleRaycastWheelCollide.h"
...
void VehicleSetup::setupVehicleData( hkpWorld* world, hkpVehicleData& data )
{
	...
	data.m_chassisUnitInertiaRoll = 0.4f; 
	...
	data.m_wheelParams[0].m_friction = 1.25f;
	data.m_wheelParams[1].m_friction = 1.25f;
	data.m_wheelParams[2].m_friction = 1.27f;
	data.m_wheelParams[3].m_friction = 1.27f;

	data.m_wheelParams[0].m_slipAngle = 0.1f;
	data.m_wheelParams[1].m_slipAngle = 0.1f;
	data.m_wheelParams[2].m_slipAngle = 0.10f;
	data.m_wheelParams[3].m_slipAngle = 0.10f;
